...
namespace Heimaverkefni5_Kafbatar
{
    class BoatFinder
    {
        ...
        private static Point GetRandomPoint() 
        {
            ...
            do
            {
                //If the number of boats sunk is 4, but it does not contain the patrolboat, 
                //then pick at random, because we cannot be sure that it was placed in a favorable position

                //If that is not true however, you may pick a point from the available ones
